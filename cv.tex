...
\usepackage{graphicx}                 % For logos or icons (if needed)
...
% Footer with Git commit revision and date at the left
\fancyfoot[L]{\scriptsize \textcolor{softGray}{Jan 2, 2025 - \texttt{YourGitShortHash}}}
